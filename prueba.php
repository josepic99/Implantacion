...
//if (sesion inactiva){ redirigir a pagina principal}
...
/*Aquí comienza la página de cuenta. Debe cargar los datos del investigador 
que inició sesión, carga sus tiras de imágenes hechas, dus datos de cuenta */
echo '';
